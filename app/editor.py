...
- без емоційних слів;
- без зайвих деталей;
- різні статті про одну й ту саму подію повинні мати максимально схожий event_key.
...
Якщо в матеріалі є конкретний новий факт, розвиток події, заява, наслідок, деталь, фото/відеосупровід або оновлення — підготуй його для модерації.
Не дублюй лише практично однакові повідомлення; нові факти та суттєві оновлення мають вважатися окремими кандидатами.
...
class NewsEditor:
    ...
    async def edit(self, news):
        ...
        return EditedNews(
            ...
            event_key=str(data.get("event_key") or data.get("title") or news.title).strip(),
        )
