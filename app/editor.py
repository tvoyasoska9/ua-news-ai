...
class NewsEditor:
    ...
    def __init__(self, api_key, model, max_material_chars=7000):
        self.client = AsyncOpenAI(api_key=api_key)
        self.model = model
        self.max_material_chars = max(2500, min(int(max_material_chars), 12000))
...
- Зберігай приблизну довжину оригіналу: якщо оригінал має 300 символів,
  не пиши 1000; якщо має 1500, не перетворюй його на 3000.
