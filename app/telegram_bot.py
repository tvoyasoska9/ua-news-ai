...
class NewsBot:
    def __init__(self, settings, db):
        ...
        # item_id -> dict. Media is kept both as local paths and as Telegram
        # file_id values captured from the moderation message. The latter is the
        # reliable publication source after Railway filesystem changes/restarts.
        self.pending = {}
    ...
    async def _publish_media(self, chat_id, post_text, cached_media, local_media):
        """Publish every available media item. Never silently drop all media."""
