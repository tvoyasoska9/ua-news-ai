...
class Database:
    ...
    def exists(self, url, fingerprint=None):
        ...
        """
        retryable = {"error", "error_retry", "processing", "daily_model_limit", "quality_rejected", "quality_failed_retry"}
        if fingerprint:
    ...
    def get_recent_titles(self, limit=1000):
        ...
        retryable = ("error_retry", "processing", "daily_model_limit", "quality_rejected", "quality_failed_retry")
